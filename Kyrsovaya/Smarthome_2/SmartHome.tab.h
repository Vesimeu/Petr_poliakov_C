...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    PRINT = 269,                   /* PRINT  */
    END = 270,                     /* END  */
    LIGHT_ON = 271,                /* LIGHT_ON  */
    LIGHT_OFF = 272,               /* LIGHT_OFF  */
    BLINDS_ON = 273,               /* BLINDS_ON  */
    BLINDS_OFF = 274,              /* BLINDS_OFF  */
    INFO = 275,                    /* INFO  */
    GREATER = 276,                 /* GREATER  */
    LESS = 277,                    /* LESS  */
    EQUAL = 278,                   /* EQUAL  */
    STRING = 279,                  /* STRING  */
    ID = 280,                      /* ID  */
    SET_VOLUME = 281,              /* SET_VOLUME  */
    SET_CONDITIONER = 282          /* SET_CONDITIONER  */
  };
